...
class CentralOesteScraper(FarmaciaScraper):
    ...
    def _scrape(self, url: str) -> tuple[float | None, float | None]:
        ...
        # El precio del producto principal esta dentro de .product-info-price
        # Los sugeridos usan .product-item-details — los ignoramos
        contenedor = soup.select_one(".product-info-price")
        if contenedor is None:
            return None, None

        precios = contenedor.select("span.price-wrapper.price-including-tax span.price")
